...
main (int argc, char *argv[])
{
  ...
  anim.SetConstantPosition(c.Get(0),30.0,30.0);
  anim.SetConstantPosition(c.Get(1),15.0,25.0);
  anim.SetConstantPosition(c.Get(2),5.0,15.0);
  anim.SetConstantPosition(c.Get(3),20.0,35.0);  
  Simulator::Run ();
  NS_LOG_INFO ("Done.");
